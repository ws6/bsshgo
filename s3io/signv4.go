...
func V4Signer() Signer {
	return v4{}
}

// Sign signs the http.Request using a given Bucket
func (v4) Sign(b *Bucket, req *http.Request) {
	if req.Header == nil {
...
func (s *v4Signer) buildTime() {
	s.Request.Header.Set("X-Amz-Date", s.Time.UTC().Format(isoFormat))
}

func (s *v4Signer) buildCredentialString() {
...
func (s *v4Signer) buildCanonicalHeaders() {
	var headers []string
...
func (s *v4Signer) buildCanonicalString() {
...
func (s *v4Signer) buildStringToSign() {
...
func (s *v4Signer) buildSignature() {
...
func (s *v4Signer) bodyDigest() string {
