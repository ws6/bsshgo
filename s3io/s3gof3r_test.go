...
//	{"no-md5", &Config{Scheme: "https", Client: ClientWithTimeout(clientTimeout)}, 1, nil},
//	{"NoKey", nil, -1, &RespError{StatusCode: 404, Message: "The specified key does not exist."}},
//	{"", nil, -1, fmt.Errorf("empty path requested")},
//	{"1_mb_test",
//		&Config{Concurrency: 2, PartSize: 5 * mb, NTry: 2, Scheme: "https", Client: ClientWithTimeout(2 * time.Second)},
//		1 * mb,
//		nil},
//	{"b1", nil, 1, nil},
//	{"0byte", &Config{Scheme: "https", Client: ClientWithTimeout(clientTimeout)}, 0, nil},
//}
//
...
//			&Config{Concurrency: 1, PartSize: 5 * mb, NTry: 1, Scheme: "http", Client: http.DefaultClient}, 3, nil},
//		{"noconc", []byte("foo"), nil,
//			&Config{Concurrency: 0, PartSize: 5 * mb, NTry: 1, Scheme: "https", Client: ClientWithTimeout(5 * time.Second)}, 3, nil},
...
//			&Config{Concurrency: 3, PartSize: 5 * mb, NTry: 2, Scheme: "https",
//				Client: ClientWithTimeout(5 * time.Second)}, 21 * mb, nil},
//		{"timeout.test1", &randSrc{Size: int(1 * mb)}, goodHeader(),
//			&Config{Concurrency: 1, PartSize: 5 * mb, NTry: 1, Scheme: "https",
...
//			&Config{Concurrency: 4, PartSize: 5 * mb, NTry: 3, Scheme: "https",
...
//	p, err := b.PutWriter("test", nil, nil)
//	if err != nil {
//		t.Fatal(err)
//	}
...
//	g, _, err := b.GetReader("test", nil)
//	if err != nil {
//		t.Fatal(err)
//	}
//	terr := fmt.Errorf("test error")
//	g.err = terr
//	_, err = g.Read([]byte("foo"))
//	if err != terr {
